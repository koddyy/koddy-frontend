const tzData = {
  ianaVersion: "2023d",
  fullVersionId: "TZDB: 2023d (mapping: $Revision$)",
  zones: [
    {
      id: "Africa/Abidjan",
      aliases: [
    ...
    },
    {
      ...
      aliases: ["America/Fort_Wayne", "America/Indianapolis", "US/East-Indiana"],
      location: {
        countryCode: "US",
        countryName: "United States",
    ...
    {
      id: "Etc/UTC",
      aliases: ["Etc/UCT", "Etc/Universal", "Etc/Zulu", "UCT", "UTC", "Universal", "Zulu"],
      location: null,
      offsets: ["\u002B00"],
      currentOffset: "\u002B00 (UTC)",
      nextTransition: {},
    },
    {
      id: "Europe/Andorra",
    ...
    {
      id: "Europe/Brussels",
      aliases: ["Europe/Amsterdam", "Europe/Luxembourg"],
      location: {
        countryCode: "BE",
        countryName: "Belgium",
        comment: "",
    ...
    },
    {
      ...
      aliases: ["Antarctica/DumontDUrville", "Pacific/Chuuk", "Pacific/Truk", "Pacific/Yap"],
      location: {
        countryCode: "PG",
        countryName: "Papua New Guinea",
    ...
    {
      id: "Pacific/Tarawa",
      aliases: ["Pacific/Funafuti", "Pacific/Majuro", "Pacific/Wake", "Pacific/Wallis"],
      location: {
        countryCode: "KI",
        countryName: "Kiribati",
...
export const timezones = tzData.zones.map(({ id }) => id);
